        ...
        <div className="min-h-screen flex" style={{ background: "var(--c-surface)" }}>
            ...
            <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-12"
                ...
                <div className="animate-fade-up stagger">
                    <p className="text-sm font-medium mb-6 uppercase tracking-widest"
                        style={{ color: "var(--c-accent)" }}>
                        Welcome Back
                    </p>
                    <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "2.8rem", lineHeight: 1.1, color: "white" }}>
                    ...
                    {/* Testimonial */}
                    <div className="mt-12 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                        <p style={{ color: "#D1D5DB", fontSize: "0.875rem", lineHeight: 1.7, fontStyle: "italic" }}>
                            "Sold my old physics textbook in 20 minutes. This app is genuinely useful for college students."
                        </p>
                        <div className="flex items-center gap-3 mt-4">
                            <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white"
                                style={{ background: "var(--c-accent)" }}>R</div>
                            <div>
                                <p style={{ color: "white", fontWeight: 600, fontSize: "0.8rem" }}>Riya Sharma</p>
                                <p style={{ color: "#6B7280", fontSize: "0.75rem" }}>IIT Delhi, CS 3rd Year</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full max-w-md animate-fade-up">
                    ...
                    {error && (
                        <div className="mb-6 p-4 rounded-xl text-sm animate-fade-in"
                            style={{ background: "#FEF2F2", border: "1px solid #FEE2E2", color: "var(--c-red)" }}>
                            {error}
                        </div>
                    )}
        ...
        <div className="relative">
            {icon && (
                <span className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"
                    style={{ color: "var(--c-ink-light)" }}>{icon}</span>
            )}
            {children}
            {right}
        </div>
