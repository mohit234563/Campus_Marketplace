...
const { totalUsers,getProductStats,sellItem,buyItem, myProducts,productList, editItem, deleteItem } = require('../controllers/productControllers');


router.get('/totalUsers',totalUsers);//done
router.get('/ProductStates',getProductStats);
